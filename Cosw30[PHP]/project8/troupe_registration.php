  ...
  <body>
    <header>
      ...
      <nav>
        <ul>
          <li>
            <a href="troupe_directory.php">Account Directory</a>
          </li>
        </ul>
      </nav>
    </header>
    ...
    <main>
      <section>
        <form enctype="multipart/form-data" name="newArtist" method="POST" action="troupe_registration.php">
          <fieldset>
            ...
            <p>Select a JPEG or PNG image of 1000KB or smaller for profile picture:</p>
      ...
      <?php 
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
          ...
          // SCRIPT FOR INSERTING NEW ARTIST DATA
          ...
          if (!empty($_FILES['upload']["name"])) {
            ...
            $allowed = ['pjpeg', 'jpeg', 'JPG', 'X-PNG', 'PNG', 'png', 'x-png'];
          ...
          if (empty($errors)) {
            ...
            // Register the new artist in the database
            ...
            if ($rq) {
              ...
              // Print a message:
              echo '<h2>Welcome '.$un.'</h2><p>Thank you for registering with Troupe. An email confirmation letter will be sent to '.$ea.' very shortly. Once received, please verify your email address.</p><p><br></p>';
