  ...
  <body>
    ...
    <main>
      <section>
        ...
        <form name="newMember" method="POST" action="add_user.php">
          <fieldset>
            <p>Please fill out the new member's information.</p>
    
            <label>First Name</label>
            <input type="text" id="first_name" name="first_name" min="2" max="30" value="<?php
            if (isset($_POST['first_name'])) 
              echo $_POST['first_name']; ?>" required><br>
    
            <label>Last Name</label>
            <input type="text" id="last_name" name="last_name" min="2" max="30" value="<?php 
