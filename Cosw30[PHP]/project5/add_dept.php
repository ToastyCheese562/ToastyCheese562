  ...
  <body>
    ...
    <main>
      <section>
        ...
        <form name="newDept" method="POST" action="add_dept.php">
          <fieldset>
            <p>Please fill out the new department's information.</p>
    
            <label>Department Name</label>
            <input type="text" id="dept_name" name="dept_name" min="5" max="50" value="<?php
            if (isset($_POST['dept_name'])) 
              echo $_POST['dept_name']; ?>" required><br>
    
            <label>Number of Employees</label>
            <input type="number" id="num_of_employees" name="num_of_employees" min="1" max="500" value="<?php 
            if (isset($_POST['num_of_employees'])) 
              echo $_POST['num_of_employees']; ?>" required><br>
    
            <label>Building Number</label>
            <input type="number" id="building_number" name="building_number" min="1" max="100" value="<?php 
